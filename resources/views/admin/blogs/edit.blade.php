                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.blogs.index') }}" class="btn btn-success shadow-sm float-right"> <i
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="type_id" id="type_id">
                                            @foreach ($types as $type)
                                                <option {{ old('type', $blog->type->id) == $type->id ? 'selected' : null }}
                                ...
                                <div class="form-group row border-bottom pb-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="excerpt"
                                            value="{{ old('excerpt', $blog->excerpt) }}" id="excerpt">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom pb-4">
