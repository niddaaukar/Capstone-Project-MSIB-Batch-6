...
function navbarColorOnResize() {
    ...
    var referenceButtons = document.querySelector('.reference-buttons');
    var sidenav = document.querySelector('.sidenav');
    var body = document.body;

    // Memastikan semua elemen yang diperlukan ada sebelum melanjutkan
    if (!referenceButtons || !sidenav || !body) {
        return; // Keluar dari fungsi jika salah satu elemen tidak ditemukan
    }

    // Melakukan operasi sesuai logika yang ada
...
// Memastikan fungsi dipanggil setelah DOM sepenuhnya dimuat
document.addEventListener('DOMContentLoaded', function() {
    navbarColorOnResize();
    // Menambahkan event listener untuk memanggil fungsi saat ukuran jendela berubah
